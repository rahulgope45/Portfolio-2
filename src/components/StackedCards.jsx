...
const skillData = [
    ...
    {
        title: "Application",
        description: "Creating beautiful mobile applications with Flutter and native experiences.",
        stack: [
    ...
    },
    {
        ...
        stack: [
            { src: "https://img.icons8.com/color/96/figma--v1.png", alt: "figma" },
            { src: "https://img.icons8.com/color/96/adobe-xd--v1.png", alt: "xd" },
            { src: "https://img.icons8.com/color/96/canva.png", alt: "canva" },
        ],
...
export default function StackedSkills() {
    ...
    useGSAP(() => {
        ...
        cardsRef.current.forEach((card, index) => {
            ...
            const title = card.querySelector('.card-content h1');
            const description = card.querySelector('.card-content p');
            const techIcons = card.querySelectorAll('.tech-icon');

            // Pin each card - ALL cards unpin at the same end trigger
            ScrollTrigger.create({
                trigger: card,
                start: 'top 20%',
                endTrigger: endTriggerRef.current, // All cards use same end trigger
                end: 'top 20%',
                pin: true,
                pinSpacing: false,
                scrub: 1,
            ...
            // Scale down ONLY when next card is revealing
        ...
        <div>
            ...
            <div className="skills-wrapper" ref={wrapperRef}>
                <div className="skills-header">
                    <h1 className="skills-title"><span className="font-[Dancing_Script]">Stack I Work With</span></h1>
                    <p className="skills-subtitle">Crafting digital experiences with modern technologies</p>
                </div>
                ...
                <div className="cards-container">
                    ...
                    {/* End trigger - ALL cards unpin here */}
                    <div ref={endTriggerRef} style={{ height: '1px', marginTop: '150px' }}></div>
                </div>
            </div>
